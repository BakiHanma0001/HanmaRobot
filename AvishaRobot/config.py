...
class Config(object):
    ...
    OWNER_ID = getenv("OWNER_ID", "6439346165") 

    OWNER_USERNAME = ("OWNER_USERNAME", "baki_hanma_0001")
    
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "Satan_Fucker")
   
    START_IMG = getenv("START_IMG", "https://telegra.ph/file/3d5b8fa14645a791b96f3.jpg")

    JOIN_LOGGER = getenv("JOIN_LOGGER", "-1002067491336")
   
    EVENT_LOGS = getenv("EVENT_LOGS",  "-1002067491336")
  
    ERROR_LOGS = getenv("ERROR_LOGS", "-1002067491336")

    MONGO_DB_URI= getenv("MONGO_DB_URI", None)
   
    LOG_CHANNEL = getenv("LOG_CHANNEL", "-1002067491336")
    ...
    SPAMWATCH_SUPPORT_CHAT = getenv("SPAMWATCH_SUPPORT_CHAT", "Satan_Fucker")
